-- docs/supabase/reservations_import_2026-05-27.sql
--
-- ResNexus channel-manager import — snapshot 2026-05-27 (daily push).
-- Source: uploaded "channel manager 05-27 - Sheet1.csv" (Block A — Reservation details).
...
from (values
  ...
  ('rx-67748-41', 'Sandra Rohwer', '41', date '2026-05-26', date '2026-05-27', null::time, null::text, null::text[], '{"res": "67748", "channel": "Phone", "guest_raw": "Sandra Rohwer", "rooms": "41 Queen: 5/26/2026", "total": "$138.13", "paid": "$138.13", "reserved_on": "5/26/2026", "phone": "218.929.0773"}'::jsonb),
  ...
  ('rx-67764-22', 'Troy Elmer', '22', date '2026-05-27', date '2026-05-28', null::time, 'Here for father-in-law''s funeral - wife booked - Angela', null::text[], '{"res": "67764", "channel": "Phone", "guest_raw": "Troy Elmer", "rooms": "22 Double: 5/27/2026", "total": "$149.18", "paid": "$0.00", "reserved_on": "5/27/2026", "phone": "715.557.0419", "email": "angie708892@gmail.com", "notes": "Here for father-in-law''s funeral - wife booked - Angela"}'::jsonb),
  ('rx-66850-33', 'Susan Meade', '33', date '2026-05-27', date '2026-05-31', null::time, null::text, null::text[], '{"res": "66850", "channel": "Phone", "guest_raw": "Susan Meade", "rooms": "33 Queen: 5/27/2026-5/30/2026", "total": "$517.14", "paid": "$100.00", "reserved_on": "4/7/2026", "phone": "720.308.9505"}'::jsonb),
  ...
  ('rx-66853-38', 'Douglas Schulte', '38', date '2026-05-31', date '2026-06-06', null::time, null::text, null::text[], '{"res": "66853", "channel": "Phone", "guest_raw": "Douglas Schulte", "rooms": "38 King Jacuzzi Room: 5/31/2026-6/5/2026", "total": "$663.00", "paid": "$0.00", "reserved_on": "4/7/2026", "phone": "480.215.7561", "email": "foxschulte@live.com"}'::jsonb),
  ('rx-67309-41', 'Tamzid Bin Mafiz', '41', date '2026-05-31', date '2026-06-04', null::time, null::text, array['$55 a night']::text[], '{"res": "67309", "channel": "Phone", "guest_raw": "Tamzid Bin Mafiz, *** ($55 a night)", "rooms": "41 Queen: 5/31/2026-6/3/2026", "total": "$563.57", "paid": "$0.00", "rate_note": "$55 a night", "reserved_on": "5/5/2026", "phone": "651.307.6676", "email": "tamzidm@gmail.com"}'::jsonb),
...
-- Verification (snapshot 2026-05-27):
-- select count(*) from public.reservations where external_id like 'rx-%';   -- expect >= 27 (cumulative across snapshots)
